...
| Copied filtered URLs | Copy and reopen Map and Places URLs containing q, repeated category, city, district, assetType, and heritageCriteria. | All shared parameters round-trip and Map ↔ Places links preserve them. | [ ] | [ ] | URLs: |

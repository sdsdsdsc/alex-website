...
The authoritative source transcription is [`docs/audits/phase-14a-ten-record-official-chinese-source-table.md`](./phase-14a-ten-record-official-chinese-source-table.md). Record IDs are the only join key between that source table and this review.

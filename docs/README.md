...
- [docs/phase-15c-2-official-geometry-rendering.md](./phase-15c-2-official-geometry-rendering.md): Meaning-driven static line and area styles, feature-level Leaflet rendering, accessible non-Point activation, safe provenance-aware popups, official-category integration, atomic failure, and synthetic coverage for all validated geometry families. Status: implemented locally on `codex/official-geometry-rendering`; unstaged, uncommitted, unpushed, unreviewed, unmerged, and undeployed. Production remains unchanged with five Point features, and no real non-Point geometry is published. PR 5C has not started.

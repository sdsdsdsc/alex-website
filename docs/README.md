...
- [docs/phase-15b-4-xinyu-official-marker-expansion.md](./phase-15b-4-xinyu-official-marker-expansion.md): Evidence, GCJ-02-to-WGS84 reconciliation, public-location meanings, uncertainty, exclusions, and generated counts for the bounded four-marker Xinyu provincial expansion. Status: committed and pushed to `codex/xinyu-official-marker-expansion`; draft PR #56 is open and its push and pull-request verification passed. The PR remains unapproved, unmerged, and undeployed; production on `main` is unchanged.

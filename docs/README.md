...
- Map Layers tab: the Phase 15B-2 UI implementation adds an authoritative, accessible fourth tab to the existing Heritage Explorer for the community and provincial overlays while retaining the separate Leaflet basemap chooser and full-width Map column. Status: implemented and verified; committed on `codex/map-layers-sidebar`, pushed to GitHub, and open in draft PR #53; not yet approved, merged, or deployed; production remains unchanged.
...
- [maintenance/README-gallery-cleanup.md](../maintenance/README-gallery-cleanup.md): Maintenance-only gallery cleanup note. Status: reference.
- [scripts/README-community-places-import.md](../scripts/README-community-places-import.md): Import script usage note. Status: reference.

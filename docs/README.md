...
- [docs/phase-15c-3-first-real-official-geometry.md](./phase-15c-3-first-real-official-geometry.md): Historical first-candidate audit using the original strict evidence gate. It withheld every candidate from publication, with Xieli recorded as the strongest but still unresolved option. Status: preserved for audit history and superseded by the Phase 15C-4 re-audit and the controlling Phase 15C-6 policy; it is not implementation approval.
- [docs/phase-15c-4-xinyu-mixed-geometry-reaudit.md](./phase-15c-4-xinyu-mixed-geometry-reaudit.md): Historical mixed-geometry re-audit that introduced project-reference geometry and recommended a single Xieli generalized reference area under its then-current classification scheme. Status: preserved for audit history; its classification scheme and batch recommendation are superseded by Phase 15C-6.
- [docs/phase-15c-5-xiabu-geometry-pilot.md](./phase-15c-5-xiabu-geometry-pilot.md): Authoritative detailed Xiabu evidence record covering the Gaode, Baidu, Google, plaque-identity, coordinate-reconciliation, uncertainty, and Point-semantics review. Status: evidence review only. Xiabu is a proposed future Point candidate and must not be implemented or published without explicit approval.
- [docs/phase-15c-6-official-record-publication-policy-and-batch-plan.md](./phase-15c-6-official-record-publication-policy-and-batch-plan.md): Controlling current official-record publication policy and batch plan. It consolidates Phases 15C-3 through 15C-5, replaces the earlier letter classifications with publication outcomes, and records the proposed bounded future batch. Status: current policy and planning authority only; it does not approve implementation or publication.

...
- [docs/phase-15b-1-generalized-official-heritage-map-marker-model.md](./phase-15b-1-generalized-official-heritage-map-marker-model.md): Separate reviewed public-location decisions, deterministic aggregate GeoJSON, generalized-reference gates, and the bounded one-marker Xinyu pilot for official protected heritage. Status: local implementation prepared for review.

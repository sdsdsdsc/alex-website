...
- [docs/phase-14c-coordinate-evidence-and-review.md](./phase-14c-coordinate-evidence-and-review.md): Phase 14C candidate coordinate evidence and review for all ten provincial heritage pilot records; documentation-only research with no machine dataset, GeoJSON, or Map integration. Status: active draft research.

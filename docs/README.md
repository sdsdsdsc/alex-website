...
- [docs/phase-14b-translation-structured-location-review.md](./phase-14b-translation-structured-location-review.md): Phase 14B project romanization, draft English translation, and structured-location review for the ten-record pilot; no coordinates, GeoJSON, Map integration, or runtime data. Status: active draft review.

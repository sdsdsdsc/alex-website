...
it evaluates no candidate and changes no earlier outcome. The next evidence
step is a separate whole-universe reassessment of all 55 unpublished
identities, without a predetermined shortlist. The
...
evidence gates; Phase 15C-16 historically approved no generalized-reference-
Point implementation; and Phase 15C-17 changes policy only.**
...
7. apply the candidate-neutral Phase 15C-17 recalibration without changing any
   historical candidate outcome;
8. in a separate PR #76-equivalent audit, rescreen all 55 unpublished
   identities under R1–R13 and publish nothing;
...
### Phase 15C-17 Generalized reference Point policy recalibration — documentation only

Preserve the verified seven ordinary production Points and the historical
Phase 15C-16 zero-eligible result. Recalibrate only the candidate-neutral
Generalized reference Point gate: distinguish ordinary feature Points from
representative general-vicinity markers, define bounded-support and
multi-datum-envelope methods, keep numerical concepts separate, and retain
strict identity, sensitivity, comprehension, review, supersession, and
publication safeguards. Do not reassess any identity. A later
PR #76-equivalent audit must rescreen all 55 unpublished identities and publish
nothing. Do not change data, runtime, schema implementation, rendering,
Community Heritage, Firebase, or production in this documentation-only phase.

...
const GEOMETRY_MEANING_PRESENTATION_LABELS = Object.freeze({
  ...
  "heritage-building-reference-point": "Heritage building reference point (approximate project-reviewed location)",
...
const REQUIRED_PRECISION_BY_MEANING = Object.freeze({
  ...
  "heritage-building-reference-point": "approximate",
